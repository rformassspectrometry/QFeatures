...
2. [@2] Multi-set case, multiplexed: requires =colAnnotation= and
   =runCol=.
...
3. [@3] Multi-set case, LF: requires =colData= and =runCol= with a
   optional =multiplexing= (for plexDIA).
...
4. [@4] Special case DIANN. A specialised function that parses the table
   to case 2.
