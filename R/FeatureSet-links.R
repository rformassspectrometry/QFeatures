...
##' Links between FeatureSets
##'
##'
##' This class handles the slots to link different FeatureSets within
##' a Features object. It isn't meant to be used directly by users.
##'
...
##' @exportClass FeatureSetLink
##' @md
setClass("FeatureSetLink",
         slots = c(id = "integer",
                   from = "integer",
                   fcol = "character"),
         prototype = prototype(
