...
```{r featuresplot, fig.cap = "Conceptual representation of a `Features` object and the relation between different assays.", echo = FALSE}
par(mar = c(0, 0, 0, 0))
...
respective assays of a `Features` object. A dropdown meny in the side
bar allows the user to select an assay of interest, which can then be visualised as a heatmap (figure 
